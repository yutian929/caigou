...
from caigou_pkg.yolov5_deepsort.utils.general import LOGGER, check_version, colorstr, file_date, git_describe
...
def reshape_classifier_output(model, n=1000):
    ...
    from caigou_pkg.yolov5_deepsort.models.common import Classify
